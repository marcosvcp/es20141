...
public class Treloso extends PlayerChar {
	...
	public void initImages() {
		super.getCharImagens()[0] = new Texture(
				Gdx.files.internal(Assets.TRELOSO_IMAGE_ONE));
		super.getCharImagens()[1] = new Texture(
				Gdx.files.internal(Assets.TRELOSO_IMAGE_TWO));
		super.getCharImagens()[2] = new Texture(
				Gdx.files.internal(Assets.TRELOSO_IMAGE_THREE));
		super.getCharImagens()[3] = new Texture(
				Gdx.files.internal(Assets.TRELOSO_IMAGE_FOUR));
		super.getCharImagens()[4] = new Texture(
				Gdx.files.internal(Assets.TRELOSO_IMAGE_FIVE));
