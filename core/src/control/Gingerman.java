...
public class Gingerman extends Rectangle {
	...
	public Gingerman() {
		...
		color = Color.GREEN;
		visualLifeRectangle = new Rectangle(Game.WIDTH - 40, 20, 20, INITIAL_RECTANGLE_LIFE_HEIGHT  );
		imageNames[0] = new Texture(Gdx.files.internal(Assets.GINGERMAN_IMAGE_ONE));
		imageNames[1] = new Texture(Gdx.files.internal(Assets.GINGERMAN_IMAGE_TWO));
		imageNames[2] = new Texture(Gdx.files.internal(Assets.GINGERMAN_IMAGE_THREE));
		imageNames[3] = new Texture(Gdx.files.internal(Assets.GINGERMAN_IMAGE_FOUR));
		imageNames[4] = new Texture(Gdx.files.internal(Assets.GINGERMAN_IMAGE_FIVE));
		setGingermanImage(new Texture(Gdx.files.internal(Assets.GINGERMAN_IMAGE_ONE)));
	...
	public void updateLife(int life) {
		...
		visualLifeRectangle.height = (this.life * INITIAL_RECTANGLE_LIFE_HEIGHT)/100; //Regra de 3
	}
